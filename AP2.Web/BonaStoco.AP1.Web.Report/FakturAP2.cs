...
namespace BonaStoco.AP1.Web.Report
{
    ...
    public class FakturAP2:IViewModel
    {
...
select bd.id,
    ...
    public class DetailFakturAP2 : IViewModel
    {
        public long Id { get; set; }
