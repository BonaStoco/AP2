...
function CreateDivDetail() {
    ...
    var dates = $("#dari, #sampai").datepicker({ dateFormat: 'yy-mm-dd',
        ...
        onSelect: function (selectedDate) {
            ...
            SearchSessionDetail(dari, sampai);
        }
    });
...
function FindDetail() {
    ...
    $.ajax({
        type: "GET",
        url: "/LaporanVoid/FindDetailVoidPerKasirByDate",
        data: { "dari": dari, "sampai": sampai, "sessionId": sessionId },
        dataType: "json",
...
function SearchSessionDetail(dari, sampai) {
    if (dari == "" || sampai == "") {
    ...
    $.ajax({
        type: "GET",
        url: "/LaporanVoid/FindSessionByTenantAndDate",
